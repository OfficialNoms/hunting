...
Config.Animals = {
	[-832573324] = 	{ModNam = 'a_c_boar', 			label = "Boar", 		minWeight = 4000, 	maxWeight = 5000},
	[1462895032] = 	{ ModNam = 'a_c_cat_01', 		label = "Cat", 			minWeight = 2000, 	maxWeight = 5000},
	[-1430839454] = { ModNam = 'a_c_chickenhawk', 	label = "Chicken", 		minWeight = 1000, 	maxWeight = 2000},
	[-1469565163] = { ModNam = 'a_c_chimp', 		label = "Monkey", 		minWeight = 2000, 	maxWeight = 4000},
	[351016938] = 	{ ModNam = 'a_c_chop', 			label = "Dog", 			minWeight = 2000, 	maxWeight = 4000},
	[1457690978] = 	{ ModNam = 'a_c_cormorant', 	label = "Cormorant", 	minWeight = 800, 	maxWeight = 1600},
	[-50684386] = 	{ ModNam = 'a_c_cow', 			label = "Cow", 			minWeight = 4000, 	maxWeight = 8000},
	[1682622302] = 	{ ModNam = 'a_c_coyote', 		label = "Coyote", 		minWeight = 1000, 	maxWeight = 2000},
	[402729631] = 	{ ModNam = 'a_c_crow', 			label = "Crow", 		minWeight = 800, 	maxWeight = 1600},
	[-664053099] = 	{ ModNam = 'a_c_deer', 			label = "Deer", 		minWeight = 4000, 	maxWeight = 6000},
	...
	[-1920284487] = { ModNam = 'a_c_killerwhale',	label = "Whale", 		minWeight = 10000, 	maxWeight = 15000},
	[307287994] = 	{ ModNam = 'a_c_mtlion', 		label = "Cougar", 		minWeight = 4000, 	maxWeight = 6000},
	[-1323586730] = { ModNam = 'a_c_pig', 			label = "Pig", 			minWeight = 4000, 	maxWeight = 6000},
	...
	[1015224100] = 	{ ModNam = 'a_c_sharkhammer', 	label = "Shark", 		minWeight = 4000, 	maxWeight = 6000},
	[113504370] = 	{ ModNam = 'a_c_sharktiger', 	label = "Shark", 		minWeight = 4000, 	maxWeight = 6000},
	[1126154828] = 	{ ModNam = 'a_c_shepherd', 		label = "Dog", 			minWeight = 2000, 	maxWeight = 4000},
	[-1589092019] = { ModNam = 'a_c_stingray', 		label = "Stingray", 	minWeight = 800, 	maxWeight = 1600},
